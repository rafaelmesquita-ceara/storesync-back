...
public partial class AbrirCaixaDialog : Window
{
    public AbrirCaixaDialog()
    {
        InitializeComponent();
        Opened += (_, _) => ValorBox.Focus();
    }

    private void AbrirButton_Click(object? sender, RoutedEventArgs e) => TryConfirm();
    ...
    private void TryConfirm()
    {
        ...
        {
            SnackBarService.SendWarning("Informe um valor de abertura válido.");
            return;
        }
        Close(valor);
    }
